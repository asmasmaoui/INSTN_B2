 ...
 * @generated
 */
public class SimpleNNSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SimpleNNPackage.CONV1_D: {
				...
				if (result == null) result = caseLayer(conv1D);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case SimpleNNPackage.LSTM: {
				...
				if (result == null) result = caseLayer(lstm);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Conv1 D</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Conv1 D</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
