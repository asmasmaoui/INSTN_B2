...
««« loop of attributes of module (its base class) - FOR ...
				«FOR attribute : module.base_Class.ownedAttributes»
					«val layer = UMLUtil.getStereotypeApplication(attribute, Layer)»
««« assign self.<name of the attribute> with the result of the genLayer function
					«layer.genLayer»
				«ENDFOR»
